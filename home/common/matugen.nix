    ...
    "matugen/templates/hyprpanel-theme.json".text = ''
      {
        ...
        "theme.bar.buttons.modules.weather.icon_background": "{{colors.primary.default.hex}}",
        "theme.bar.buttons.modules.weather.icon": "{{colors.primary.default.hex}}",
        "theme.bar.buttons.modules.weather.text": "{{colors.primary.default.hex}}",
        "theme.bar.buttons.modules.weather.background": "{{colors.surface_container.default.hex}}",
        "theme.bar.buttons.modules.weather.border": "{{colors.primary.default.hex}}",
        "theme.bar.buttons.modules.updates.icon_background": "{{colors.secondary.default.hex}}",
        "theme.bar.buttons.modules.updates.icon": "{{colors.secondary.default.hex}}",
        "theme.bar.buttons.modules.updates.text": "{{colors.secondary.default.hex}}",
        "theme.bar.buttons.modules.updates.background": "{{colors.surface_container.default.hex}}",
        "theme.bar.buttons.modules.updates.border": "{{colors.secondary.default.hex}}",
        ...
        "theme.bar.buttons.modules.netstat.icon_background": "{{colors.secondary.default.hex}}",
        "theme.bar.buttons.modules.netstat.icon": "{{colors.secondary.default.hex}}",
        "theme.bar.buttons.modules.netstat.text": "{{colors.secondary.default.hex}}",
        "theme.bar.buttons.modules.netstat.background": "{{colors.surface_container.default.hex}}",
        "theme.bar.buttons.modules.netstat.border": "{{colors.secondary.default.hex}}",
        "theme.bar.buttons.modules.storage.icon_background": "{{colors.primary.default.hex}}",
        "theme.bar.buttons.modules.storage.icon": "{{colors.primary.default.hex}}",
        "theme.bar.buttons.modules.storage.text": "{{colors.primary.default.hex}}",
        "theme.bar.buttons.modules.storage.background": "{{colors.surface_container.default.hex}}",
        "theme.bar.buttons.modules.storage.border": "{{colors.primary.default.hex}}",
        ...
        "theme.bar.buttons.modules.submap.icon": "{{colors.tertiary.default.hex}}",
        "theme.bar.buttons.modules.submap.background": "{{colors.surface_container.default.hex}}",
        "theme.bar.buttons.modules.submap.icon_background": "{{colors.surface_container.default.hex}}",
        "theme.bar.buttons.modules.submap.text": "{{colors.tertiary.default.hex}}",
        "theme.bar.buttons.modules.submap.border": "{{colors.tertiary.default.hex}}",
        "theme.bar.buttons.modules.hyprsunset.icon": "{{colors.primary_container.default.hex}}",
        "theme.bar.buttons.modules.hyprsunset.background": "{{colors.surface_container.default.hex}}",
        "theme.bar.buttons.modules.hyprsunset.icon_background": "{{colors.surface_container.default.hex}}",
        "theme.bar.buttons.modules.hyprsunset.text": "{{colors.primary_container.default.hex}}",
        "theme.bar.buttons.modules.hyprsunset.border": "{{colors.primary_container.default.hex}}",
        ...
        "theme.bar.buttons.modules.cava.text": "{{colors.tertiary.default.hex}}",
        "theme.bar.buttons.modules.cava.background": "{{colors.surface_container.default.hex}}",
        "theme.bar.buttons.modules.cava.icon_background": "{{colors.surface_container.default.hex}}",
        "theme.bar.buttons.modules.cava.icon": "{{colors.tertiary.default.hex}}",
        "theme.bar.buttons.modules.cava.border": "{{colors.tertiary.default.hex}}",
        "theme.bar.buttons.modules.worldclock.text": "{{colors.primary_container.default.hex}}",
        "theme.bar.buttons.modules.worldclock.background": "{{colors.surface_container.default.hex}}",
        "theme.bar.buttons.modules.worldclock.icon_background": "{{colors.primary_container.default.hex}}",
        "theme.bar.buttons.modules.worldclock.icon": "{{colors.primary_container.default.hex}}",
        "theme.bar.buttons.modules.worldclock.border": "{{colors.primary_container.default.hex}}",
        ...
        "theme.bar.buttons.modules.microphone.icon_background": "{{colors.surface_container.default.hex}}",

        "theme.bar.buttons.notifications.total": "{{colors.primary.default.hex}}",
        "theme.bar.buttons.notifications.icon_background": "{{colors.primary.default.hex}}",
        "theme.bar.buttons.notifications.icon": "{{colors.primary.default.hex}}",
        "theme.bar.buttons.notifications.background": "{{colors.surface_container.default.hex}}",
        "theme.bar.buttons.notifications.border": "{{colors.primary.default.hex}}",
        ...
        "theme.bar.buttons.battery.icon_background": "{{colors.tertiary.default.hex}}",
        "theme.bar.buttons.battery.icon": "{{colors.tertiary.default.hex}}",
        "theme.bar.buttons.battery.text": "{{colors.tertiary.default.hex}}",
        "theme.bar.buttons.battery.background": "{{colors.surface_container.default.hex}}",
        "theme.bar.buttons.battery.border": "{{colors.tertiary.default.hex}}",
        "theme.bar.buttons.systray.background": "{{colors.surface_container.default.hex}}",
        "theme.bar.buttons.systray.border": "{{colors.primary.default.hex}}",
        ...
        "theme.bar.buttons.media.icon_background": "{{colors.primary.default.hex}}",
        "theme.bar.buttons.media.icon": "{{colors.primary.default.hex}}",
        "theme.bar.buttons.media.text": "{{colors.primary.default.hex}}",
        "theme.bar.buttons.media.background": "{{colors.surface_container.default.hex}}",
        "theme.bar.buttons.media.border": "{{colors.primary.default.hex}}",
        "theme.bar.buttons.windowtitle.icon_background": "{{colors.primary_container.default.hex}}",
        "theme.bar.buttons.windowtitle.icon": "{{colors.primary_container.default.hex}}",
        "theme.bar.buttons.windowtitle.text": "{{colors.primary_container.default.hex}}",
        "theme.bar.buttons.windowtitle.border": "{{colors.primary_container.default.hex}}",
        ...
        "theme.bar.buttons.workspaces.numbered_active_highlighted_text_color": "{{colors.on_primary.default.hex}}",
        ...
        "theme.bar.buttons.workspaces.occupied": "{{colors.secondary.default.hex}}",
        "theme.bar.buttons.workspaces.available": "{{colors.tertiary.default.hex}}",
        ...
        "theme.bar.buttons.icon_background": "{{colors.surface_container.default.hex}}",
